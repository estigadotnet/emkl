...
// Create page object
$t101_jo_head_add = new t101_jo_head_add();

// Run the page
$t101_jo_head_add->run();
...
var ft101_jo_headadd = currentForm = new ew.Form("ft101_jo_headadd", "add");

// Validate form
ft101_jo_headadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($t101_jo_head_add->Shipper_id->Required) { ?>
		...
		<?php } ?>
		<?php if ($t101_jo_head_add->Party->Required) { ?>
		...
		<?php if ($t101_jo_head_add->Container->Required) { ?>
		...
		<?php } ?>
		<?php if ($t101_jo_head_add->Feeder_id->Required) { ?>
...
ft101_jo_headadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
ft101_jo_headadd.lists["x_Container"].options = <?php echo JsonEncode($t101_jo_head_add->Container->options(FALSE, TRUE)) ?>;
ft101_jo_headadd.lists["x_Destination_id"] = <?php echo $t101_jo_head_add->Destination_id->Lookup->toClientList() ?>;
ft101_jo_headadd.lists["x_Destination_id"].options = <?php echo JsonEncode($t101_jo_head_add->Destination_id->lookupOptions()) ?>;
ft101_jo_headadd.lists["x_Feeder_id"] = <?php echo $t101_jo_head_add->Feeder_id->Lookup->toClientList() ?>;
ft101_jo_headadd.lists["x_Feeder_id"].options = <?php echo JsonEncode($t101_jo_head_add->Feeder_id->lookupOptions()) ?>;
...
<?php $t101_jo_head_add->showPageHeader(); ?>
<?php
$t101_jo_head_add->showMessage();
?>
<form name="ft101_jo_headadd" id="ft101_jo_headadd" class="<?php echo $t101_jo_head_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($t101_jo_head_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $t101_jo_head_add->Token ?>">
<?php } ?>
...
<?php if ($t101_jo_head->Shipper_id->Visible) { // Shipper_id ?>
	<div id="r_Shipper_id" class="form-group row">
		<label id="elh_t101_jo_head_Shipper_id" for="x_Shipper_id" class="<?php echo $t101_jo_head_add->LeftColumnClass ?>"><?php echo $t101_jo_head->Shipper_id->caption() ?><?php echo ($t101_jo_head->Shipper_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t101_jo_head_add->RightColumnClass ?>"><div<?php echo $t101_jo_head->Shipper_id->cellAttributes() ?>>
...
<?php if ($t101_jo_head->Party->Visible) { // Party ?>
	<div id="r_Party" class="form-group row">
		<label id="elh_t101_jo_head_Party" for="x_Party" class="<?php echo $t101_jo_head_add->LeftColumnClass ?>"><?php echo $t101_jo_head->Party->caption() ?><?php echo ($t101_jo_head->Party->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t101_jo_head_add->RightColumnClass ?>"><div<?php echo $t101_jo_head->Party->cellAttributes() ?>>
...
<?php if ($t101_jo_head->Container->Visible) { // Container ?>
	<div id="r_Container" class="form-group row">
		<label id="elh_t101_jo_head_Container" class="<?php echo $t101_jo_head_add->LeftColumnClass ?>"><?php echo $t101_jo_head->Container->caption() ?><?php echo ($t101_jo_head->Container->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t101_jo_head_add->RightColumnClass ?>"><div<?php echo $t101_jo_head->Container->cellAttributes() ?>>
...
<?php if ($t101_jo_head->Destination_id->Visible) { // Destination_id ?>
	<div id="r_Destination_id" class="form-group row">
		<label id="elh_t101_jo_head_Destination_id" for="x_Destination_id" class="<?php echo $t101_jo_head_add->LeftColumnClass ?>"><?php echo $t101_jo_head->Destination_id->caption() ?><?php echo ($t101_jo_head->Destination_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t101_jo_head_add->RightColumnClass ?>"><div<?php echo $t101_jo_head->Destination_id->cellAttributes() ?>>
...
<?php if ($t101_jo_head->Feeder_id->Visible) { // Feeder_id ?>
	<div id="r_Feeder_id" class="form-group row">
		<label id="elh_t101_jo_head_Feeder_id" for="x_Feeder_id" class="<?php echo $t101_jo_head_add->LeftColumnClass ?>"><?php echo $t101_jo_head->Feeder_id->caption() ?><?php echo ($t101_jo_head->Feeder_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t101_jo_head_add->RightColumnClass ?>"><div<?php echo $t101_jo_head->Feeder_id->cellAttributes() ?>>
...
<?php
	if (in_array("t101_jo_detail", explode(",", $t101_jo_head->getCurrentDetailTable())) && $t101_jo_detail->DetailAdd) {
?>
...
<?php } ?>
<?php if (!$t101_jo_head_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $t101_jo_head_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $t101_jo_head_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$t101_jo_head_add->showPageFooter();
if (DEBUG_ENABLED)
