...
// Create page object
$t103_trucking_edit = new t103_trucking_edit();

// Run the page
$t103_trucking_edit->run();
...
$t103_trucking_edit->Page_Render();
?>
...
var ft103_truckingedit = currentForm = new ew.Form("ft103_truckingedit", "edit");

// Validate form
ft103_truckingedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($t103_trucking_edit->id->Required) { ?>
			elm = this.getElements("x" + infix + "_id");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $t103_trucking->id->caption(), $t103_trucking->id->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($t103_trucking_edit->EI->Required) { ?>
		...
		<?php } ?>
		<?php if ($t103_trucking_edit->Shipper_id->Required) { ?>
		...
		<?php if ($t103_trucking_edit->Party->Required) { ?>
		...
		<?php if ($t103_trucking_edit->Jenis_Container->Required) { ?>
		...
		<?php } ?>
		<?php if ($t103_trucking_edit->Tgl_Stuffing->Required) { ?>
		...
		<?php if ($t103_trucking_edit->Destination_id->Required) { ?>
		...
		<?php if ($t103_trucking_edit->Feeder_id->Required) { ?>
		...
		<?php if ($t103_trucking_edit->ETA_ETD->Required) { ?>
		...
		<?php if ($t103_trucking_edit->Liner_id->Required) { ?>
		...
		<?php if ($t103_trucking_edit->Remark->Required) { ?>
		...
		<?php } ?>
		<?php if ($t103_trucking_edit->TruckingVendor_id->Required) { ?>
		...
		<?php if ($t103_trucking_edit->Driver_id->Required) { ?>
		...
		<?php if ($t103_trucking_edit->No_Pol_1->Required) { ?>
		...
		<?php } ?>
		<?php if ($t103_trucking_edit->No_Pol_2->Required) { ?>
		...
		<?php } ?>
		<?php if ($t103_trucking_edit->No_Pol_3->Required) { ?>
		...
		<?php } ?>
		<?php if ($t103_trucking_edit->Nomor_Container_1->Required) { ?>
		...
		<?php } ?>
		<?php if ($t103_trucking_edit->Nomor_Container_2->Required) { ?>
...
ft103_truckingedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
ft103_truckingedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ft103_truckingedit.lists["x_EI"] = <?php echo $t103_trucking_edit->EI->Lookup->toClientList() ?>;
ft103_truckingedit.lists["x_EI"].options = <?php echo JsonEncode($t103_trucking_edit->EI->options(FALSE, TRUE)) ?>;
ft103_truckingedit.lists["x_Jenis_Container"] = <?php echo $t103_trucking_edit->Jenis_Container->Lookup->toClientList() ?>;
ft103_truckingedit.lists["x_Jenis_Container"].options = <?php echo JsonEncode($t103_trucking_edit->Jenis_Container->options(FALSE, TRUE)) ?>;
...
<?php $t103_trucking_edit->showPageHeader(); ?>
<?php
$t103_trucking_edit->showMessage();
?>
<form name="ft103_truckingedit" id="ft103_truckingedit" class="<?php echo $t103_trucking_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($t103_trucking_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $t103_trucking_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t103_trucking">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$t103_trucking_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($t103_trucking->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_t103_trucking_id" class="<?php echo $t103_trucking_edit->LeftColumnClass ?>"><?php echo $t103_trucking->id->caption() ?><?php echo ($t103_trucking->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t103_trucking_edit->RightColumnClass ?>"><div<?php echo $t103_trucking->id->cellAttributes() ?>>
<span id="el_t103_trucking_id">
<span<?php echo $t103_trucking->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($t103_trucking->id->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="t103_trucking" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($t103_trucking->id->CurrentValue) ?>">
<?php echo $t103_trucking->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t103_trucking->EI->Visible) { // EI ?>
	<div id="r_EI" class="form-group row">
		<label id="elh_t103_trucking_EI" class="<?php echo $t103_trucking_edit->LeftColumnClass ?>"><?php echo $t103_trucking->EI->caption() ?><?php echo ($t103_trucking->EI->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t103_trucking_edit->RightColumnClass ?>"><div<?php echo $t103_trucking->EI->cellAttributes() ?>>
...
<?php if ($t103_trucking->Shipper_id->Visible) { // Shipper_id ?>
	<div id="r_Shipper_id" class="form-group row">
		<label id="elh_t103_trucking_Shipper_id" for="x_Shipper_id" class="<?php echo $t103_trucking_edit->LeftColumnClass ?>"><?php echo $t103_trucking->Shipper_id->caption() ?><?php echo ($t103_trucking->Shipper_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t103_trucking_edit->RightColumnClass ?>"><div<?php echo $t103_trucking->Shipper_id->cellAttributes() ?>>
...
<?php if ($t103_trucking->Party->Visible) { // Party ?>
	<div id="r_Party" class="form-group row">
		<label id="elh_t103_trucking_Party" for="x_Party" class="<?php echo $t103_trucking_edit->LeftColumnClass ?>"><?php echo $t103_trucking->Party->caption() ?><?php echo ($t103_trucking->Party->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t103_trucking_edit->RightColumnClass ?>"><div<?php echo $t103_trucking->Party->cellAttributes() ?>>
...
<?php if ($t103_trucking->Jenis_Container->Visible) { // Jenis_Container ?>
	<div id="r_Jenis_Container" class="form-group row">
		<label id="elh_t103_trucking_Jenis_Container" class="<?php echo $t103_trucking_edit->LeftColumnClass ?>"><?php echo $t103_trucking->Jenis_Container->caption() ?><?php echo ($t103_trucking->Jenis_Container->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t103_trucking_edit->RightColumnClass ?>"><div<?php echo $t103_trucking->Jenis_Container->cellAttributes() ?>>
...
<?php if ($t103_trucking->Tgl_Stuffing->Visible) { // Tgl_Stuffing ?>
	<div id="r_Tgl_Stuffing" class="form-group row">
		<label id="elh_t103_trucking_Tgl_Stuffing" for="x_Tgl_Stuffing" class="<?php echo $t103_trucking_edit->LeftColumnClass ?>"><?php echo $t103_trucking->Tgl_Stuffing->caption() ?><?php echo ($t103_trucking->Tgl_Stuffing->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t103_trucking_edit->RightColumnClass ?>"><div<?php echo $t103_trucking->Tgl_Stuffing->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("ft103_truckingedit", "x_Tgl_Stuffing", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($t103_trucking->Destination_id->Visible) { // Destination_id ?>
	<div id="r_Destination_id" class="form-group row">
		<label id="elh_t103_trucking_Destination_id" for="x_Destination_id" class="<?php echo $t103_trucking_edit->LeftColumnClass ?>"><?php echo $t103_trucking->Destination_id->caption() ?><?php echo ($t103_trucking->Destination_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t103_trucking_edit->RightColumnClass ?>"><div<?php echo $t103_trucking->Destination_id->cellAttributes() ?>>
...
<?php if ($t103_trucking->Feeder_id->Visible) { // Feeder_id ?>
	<div id="r_Feeder_id" class="form-group row">
		<label id="elh_t103_trucking_Feeder_id" for="x_Feeder_id" class="<?php echo $t103_trucking_edit->LeftColumnClass ?>"><?php echo $t103_trucking->Feeder_id->caption() ?><?php echo ($t103_trucking->Feeder_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t103_trucking_edit->RightColumnClass ?>"><div<?php echo $t103_trucking->Feeder_id->cellAttributes() ?>>
...
<?php if ($t103_trucking->ETA_ETD->Visible) { // ETA_ETD ?>
	<div id="r_ETA_ETD" class="form-group row">
		<label id="elh_t103_trucking_ETA_ETD" for="x_ETA_ETD" class="<?php echo $t103_trucking_edit->LeftColumnClass ?>"><?php echo $t103_trucking->ETA_ETD->caption() ?><?php echo ($t103_trucking->ETA_ETD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t103_trucking_edit->RightColumnClass ?>"><div<?php echo $t103_trucking->ETA_ETD->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("ft103_truckingedit", "x_ETA_ETD", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($t103_trucking->Liner_id->Visible) { // Liner_id ?>
	<div id="r_Liner_id" class="form-group row">
		<label id="elh_t103_trucking_Liner_id" for="x_Liner_id" class="<?php echo $t103_trucking_edit->LeftColumnClass ?>"><?php echo $t103_trucking->Liner_id->caption() ?><?php echo ($t103_trucking->Liner_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t103_trucking_edit->RightColumnClass ?>"><div<?php echo $t103_trucking->Liner_id->cellAttributes() ?>>
...
<?php if ($t103_trucking->Remark->Visible) { // Remark ?>
	<div id="r_Remark" class="form-group row">
		<label id="elh_t103_trucking_Remark" for="x_Remark" class="<?php echo $t103_trucking_edit->LeftColumnClass ?>"><?php echo $t103_trucking->Remark->caption() ?><?php echo ($t103_trucking->Remark->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t103_trucking_edit->RightColumnClass ?>"><div<?php echo $t103_trucking->Remark->cellAttributes() ?>>
...
<?php if ($t103_trucking->TruckingVendor_id->Visible) { // TruckingVendor_id ?>
	<div id="r_TruckingVendor_id" class="form-group row">
		<label id="elh_t103_trucking_TruckingVendor_id" for="x_TruckingVendor_id" class="<?php echo $t103_trucking_edit->LeftColumnClass ?>"><?php echo $t103_trucking->TruckingVendor_id->caption() ?><?php echo ($t103_trucking->TruckingVendor_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t103_trucking_edit->RightColumnClass ?>"><div<?php echo $t103_trucking->TruckingVendor_id->cellAttributes() ?>>
...
<?php if ($t103_trucking->Driver_id->Visible) { // Driver_id ?>
	<div id="r_Driver_id" class="form-group row">
		<label id="elh_t103_trucking_Driver_id" for="x_Driver_id" class="<?php echo $t103_trucking_edit->LeftColumnClass ?>"><?php echo $t103_trucking->Driver_id->caption() ?><?php echo ($t103_trucking->Driver_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t103_trucking_edit->RightColumnClass ?>"><div<?php echo $t103_trucking->Driver_id->cellAttributes() ?>>
...
<?php if ($t103_trucking->No_Pol_1->Visible) { // No_Pol_1 ?>
	<div id="r_No_Pol_1" class="form-group row">
		<label id="elh_t103_trucking_No_Pol_1" for="x_No_Pol_1" class="<?php echo $t103_trucking_edit->LeftColumnClass ?>"><?php echo $t103_trucking->No_Pol_1->caption() ?><?php echo ($t103_trucking->No_Pol_1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t103_trucking_edit->RightColumnClass ?>"><div<?php echo $t103_trucking->No_Pol_1->cellAttributes() ?>>
...
<?php if ($t103_trucking->No_Pol_2->Visible) { // No_Pol_2 ?>
	<div id="r_No_Pol_2" class="form-group row">
		<label id="elh_t103_trucking_No_Pol_2" for="x_No_Pol_2" class="<?php echo $t103_trucking_edit->LeftColumnClass ?>"><?php echo $t103_trucking->No_Pol_2->caption() ?><?php echo ($t103_trucking->No_Pol_2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t103_trucking_edit->RightColumnClass ?>"><div<?php echo $t103_trucking->No_Pol_2->cellAttributes() ?>>
...
<?php if ($t103_trucking->No_Pol_3->Visible) { // No_Pol_3 ?>
	<div id="r_No_Pol_3" class="form-group row">
		<label id="elh_t103_trucking_No_Pol_3" for="x_No_Pol_3" class="<?php echo $t103_trucking_edit->LeftColumnClass ?>"><?php echo $t103_trucking->No_Pol_3->caption() ?><?php echo ($t103_trucking->No_Pol_3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t103_trucking_edit->RightColumnClass ?>"><div<?php echo $t103_trucking->No_Pol_3->cellAttributes() ?>>
...
<?php if ($t103_trucking->Nomor_Container_1->Visible) { // Nomor_Container_1 ?>
	<div id="r_Nomor_Container_1" class="form-group row">
		<label id="elh_t103_trucking_Nomor_Container_1" for="x_Nomor_Container_1" class="<?php echo $t103_trucking_edit->LeftColumnClass ?>"><?php echo $t103_trucking->Nomor_Container_1->caption() ?><?php echo ($t103_trucking->Nomor_Container_1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t103_trucking_edit->RightColumnClass ?>"><div<?php echo $t103_trucking->Nomor_Container_1->cellAttributes() ?>>
...
<?php if ($t103_trucking->Nomor_Container_2->Visible) { // Nomor_Container_2 ?>
	<div id="r_Nomor_Container_2" class="form-group row">
		<label id="elh_t103_trucking_Nomor_Container_2" for="x_Nomor_Container_2" class="<?php echo $t103_trucking_edit->LeftColumnClass ?>"><?php echo $t103_trucking->Nomor_Container_2->caption() ?><?php echo ($t103_trucking->Nomor_Container_2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t103_trucking_edit->RightColumnClass ?>"><div<?php echo $t103_trucking->Nomor_Container_2->cellAttributes() ?>>
...
<?php if (!$t103_trucking_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $t103_trucking_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $t103_trucking_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$t103_trucking_edit->showPageFooter();
if (DEBUG_ENABLED)
