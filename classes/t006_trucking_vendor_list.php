 ...
 * Page class
 */
class t006_trucking_vendor_list extends t006_trucking_vendor
{
	...
	// Page object name
	public $PageObjName = "t006_trucking_vendor_list";

	// Grid form hidden field names
	public $FormName = "ft006_trucking_vendorlist";
	...
	public function __construct()
	{
		...
		$this->MultiDeleteUrl = "t006_trucking_vendordelete.php";
		$this->MultiUpdateUrl = "t006_trucking_vendorupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option ft006_trucking_vendorlistsrch";
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "ft006_trucking_vendorlistsrch", $filters);
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"ft006_trucking_vendorlistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"ft006_trucking_vendorlistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.ft006_trucking_vendorlist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"ft006_trucking_vendorlistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
