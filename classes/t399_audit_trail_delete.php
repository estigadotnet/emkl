 ...
 * Page class
 */
class t399_audit_trail_delete extends t399_audit_trail
{
	...
	// Page object name
	public $PageObjName = "t399_audit_trail_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t399_audit_traillist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("t399_audit_traillist.php"); // Return to list
			}
		}
	}
