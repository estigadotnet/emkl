 ...
 * Page class
 */
class t003_feeder_view extends t003_feeder
{
	...
	// Page object name
	public $PageObjName = "t003_feeder_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t003_feederlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t003_feederlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t003_feederlist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("t003_feederlist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
