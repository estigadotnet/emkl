 ...
 * Page class
 */
class t006_trucking_vendor_delete extends t006_trucking_vendor
{
	...
	// Page object name
	public $PageObjName = "t006_trucking_vendor_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t006_trucking_vendorlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("t006_trucking_vendorlist.php"); // Return to list
			}
		}
	}
