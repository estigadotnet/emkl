 ...
 * Page class
 */
class t101_tagihan_trucking_delete extends t101_tagihan_trucking
{
	...
	// Page object name
	public $PageObjName = "t101_tagihan_trucking_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t101_tagihan_truckinglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("t101_tagihan_truckinglist.php"); // Return to list
			}
		}
	}
