 ...
 * Page class
 */
class t005_driver_view extends t005_driver
{
	...
	// Page object name
	public $PageObjName = "t005_driver_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t005_driverlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t005_driverlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t005_driverlist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
