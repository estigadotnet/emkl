 ...
 * Page class
 */
class t005_driver_delete extends t005_driver
{
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t005_driverlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("t005_driverlist.php"); // Return to list
			}
		}
	}
