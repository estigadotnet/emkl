 ...
 * Page class
 */
class t001_shipper_view extends t001_shipper
{
	...
	// Page object name
	public $PageObjName = "t001_shipper_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t001_shipperlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t001_shipperlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t001_shipperlist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("t001_shipperlist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
