...
/**
 * Table class for t097_userlevels
 */
class t097_userlevels extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 't097_userlevels';
		$this->TableName = 't097_userlevels';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t097_userlevels`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// userlevelid
		$this->userlevelid = new DbField('t097_userlevels', 't097_userlevels', 'x_userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, -1, FALSE, '`userlevelid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// userlevelname
		$this->userlevelname = new DbField('t097_userlevels', 't097_userlevels', 'x_userlevelname', 'userlevelname', '`userlevelname`', '`userlevelname`', 200, -1, FALSE, '`userlevelname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`t097_userlevels`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t097_userlevelslist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "t097_userlevelsview.php")
			return $Language->phrase("View");
		elseif ($pageName == "t097_userlevelsedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "t097_userlevelsadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("t097_userlevelsview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("t097_userlevelsview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "t097_userlevelsadd.php?" . $this->getUrlParm($parm);
		else
			$url = "t097_userlevelsadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t097_userlevelsedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t097_userlevelsadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("t097_userlevelsdelete.php", $this->getUrlParm());
	}
