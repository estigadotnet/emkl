 ...
 * Page class
 */
class t004_liner_view extends t004_liner
{
	...
	// Page object name
	public $PageObjName = "t004_liner_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t004_linerlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t004_linerlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t004_linerlist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("t004_linerlist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
