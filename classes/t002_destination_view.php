 ...
 * Page class
 */
class t002_destination_view extends t002_destination
{
	...
	// Page object name
	public $PageObjName = "t002_destination_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t002_destinationlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t002_destinationlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t002_destinationlist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("t002_destinationlist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
