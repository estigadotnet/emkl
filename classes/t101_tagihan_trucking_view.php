 ...
 * Page class
 */
class t101_tagihan_trucking_view extends t101_tagihan_trucking
{
	...
	// Page object name
	public $PageObjName = "t101_tagihan_trucking_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t101_tagihan_truckinglist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t101_tagihan_truckinglist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t101_tagihan_truckinglist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
