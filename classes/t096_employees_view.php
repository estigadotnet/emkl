 ...
 * Page class
 */
class t096_employees_view extends t096_employees
{
	...
	// Page object name
	public $PageObjName = "t096_employees_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("EmployeeID") !== NULL) {
				...
				$returnUrl = "t096_employeeslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t096_employeeslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t096_employeeslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("t096_employeeslist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
