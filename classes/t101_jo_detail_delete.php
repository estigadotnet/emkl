 ...
 * Page class
 */
class t101_jo_detail_delete extends t101_jo_detail
{
	...
	// Page object name
	public $PageObjName = "t101_jo_detail_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t101_jo_detaillist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("t101_jo_detaillist.php"); // Return to list
			}
		}
	}
	...
	protected function newRow()
	{
		...
		$row['Ref_JOHead_id'] = NULL;
		$row['No_Tagihan'] = NULL;
		$row['Jumlah_Tagihan'] = NULL;
		return $row;
	}
