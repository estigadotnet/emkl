...
/**
 * Table class for t098_userlevelpermissions
 */
class t098_userlevelpermissions extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 't098_userlevelpermissions';
		$this->TableName = 't098_userlevelpermissions';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t098_userlevelpermissions`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// userlevelid
		$this->userlevelid = new DbField('t098_userlevelpermissions', 't098_userlevelpermissions', 'x_userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, -1, FALSE, '`userlevelid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tablename
		$this->_tablename = new DbField('t098_userlevelpermissions', 't098_userlevelpermissions', 'x__tablename', 'tablename', '`tablename`', '`tablename`', 200, -1, FALSE, '`tablename`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// permission
		$this->permission = new DbField('t098_userlevelpermissions', 't098_userlevelpermissions', 'x_permission', 'permission', '`permission`', '`permission`', 3, -1, FALSE, '`permission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`t098_userlevelpermissions`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t098_userlevelpermissionslist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "t098_userlevelpermissionsview.php")
			return $Language->phrase("View");
		elseif ($pageName == "t098_userlevelpermissionsedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "t098_userlevelpermissionsadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("t098_userlevelpermissionsview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("t098_userlevelpermissionsview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "t098_userlevelpermissionsadd.php?" . $this->getUrlParm($parm);
		else
			$url = "t098_userlevelpermissionsadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t098_userlevelpermissionsedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t098_userlevelpermissionsadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("t098_userlevelpermissionsdelete.php", $this->getUrlParm());
	}
	...
	{
		$table = 't098_userlevelpermissions';
		$usr = CurrentUserName();
