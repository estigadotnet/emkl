 ...
 * Page class
 */
class t103_trucking_edit extends t103_trucking
{
	...
	// Page object name
	public $PageObjName = "t103_trucking_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// EI
			$this->EI->setDbValueDef($rsnew, $this->EI->CurrentValue, "", $this->EI->ReadOnly);
			...
			// Tgl_Stuffing
			$this->Tgl_Stuffing->setDbValueDef($rsnew, UnFormatDateTime($this->Tgl_Stuffing->CurrentValue, 0), CurrentDate(), $this->Tgl_Stuffing->ReadOnly);
			...
			// ETA_ETD
			$this->ETA_ETD->setDbValueDef($rsnew, UnFormatDateTime($this->ETA_ETD->CurrentValue, 0), CurrentDate(), $this->ETA_ETD->ReadOnly);

			// Liner_id
			$this->Liner_id->setDbValueDef($rsnew, $this->Liner_id->CurrentValue, 0, $this->Liner_id->ReadOnly);

			// Remark
			$this->Remark->setDbValueDef($rsnew, $this->Remark->CurrentValue, "", $this->Remark->ReadOnly);
			...
			// No_Pol_1
			$this->No_Pol_1->setDbValueDef($rsnew, $this->No_Pol_1->CurrentValue, "", $this->No_Pol_1->ReadOnly);

			// No_Pol_2
			$this->No_Pol_2->setDbValueDef($rsnew, $this->No_Pol_2->CurrentValue, "", $this->No_Pol_2->ReadOnly);

			// No_Pol_3
			$this->No_Pol_3->setDbValueDef($rsnew, $this->No_Pol_3->CurrentValue, "", $this->No_Pol_3->ReadOnly);
