 ...
 * Page class
 */
class t096_employees_delete extends t096_employees
{
	...
	// Page object name
	public $PageObjName = "t096_employees_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t096_employeeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("t096_employeeslist.php"); // Return to list
			}
		}
	}
