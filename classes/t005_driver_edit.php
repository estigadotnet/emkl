 ...
 * Page class
 */
class t005_driver_edit extends t005_driver
{
	...
	// Page object name
	public $PageObjName = "t005_driver_edit";
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("t005_driverlist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "t005_driverlist.php")
