 ...
 * Page class
 */
class t097_userlevels_view extends t097_userlevels
{
	...
	// Page object name
	public $PageObjName = "t097_userlevels_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("userlevelid") !== NULL) {
				...
				$returnUrl = "t097_userlevelslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t097_userlevelslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t097_userlevelslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("t097_userlevelslist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
