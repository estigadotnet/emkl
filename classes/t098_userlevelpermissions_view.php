 ...
 * Page class
 */
class t098_userlevelpermissions_view extends t098_userlevelpermissions
{
	...
	// Page object name
	public $PageObjName = "t098_userlevelpermissions_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("userlevelid") !== NULL) {
				...
				$returnUrl = "t098_userlevelpermissionslist.php"; // Return to list
			}
			if (Get("_tablename") !== NULL) {
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t098_userlevelpermissionslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t098_userlevelpermissionslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("t098_userlevelpermissionslist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
