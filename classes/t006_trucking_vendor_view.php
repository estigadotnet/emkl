 ...
 * Page class
 */
class t006_trucking_vendor_view extends t006_trucking_vendor
{
	...
	// Page object name
	public $PageObjName = "t006_trucking_vendor_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t006_trucking_vendorlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t006_trucking_vendorlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t006_trucking_vendorlist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
