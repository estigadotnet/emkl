...
// Create page object
$t096_employees_add = new t096_employees_add();

// Run the page
$t096_employees_add->run();
...
$t096_employees_add->Page_Render();
?>
...
var ft096_employeesadd = currentForm = new ew.Form("ft096_employeesadd", "add");

// Validate form
ft096_employeesadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($t096_employees_add->LastName->Required) { ?>
		...
		<?php } ?>
		<?php if ($t096_employees_add->FirstName->Required) { ?>
		...
		<?php } ?>
		<?php if ($t096_employees_add->Title->Required) { ?>
		...
		<?php } ?>
		<?php if ($t096_employees_add->TitleOfCourtesy->Required) { ?>
		...
		<?php } ?>
		<?php if ($t096_employees_add->BirthDate->Required) { ?>
		...
		<?php if ($t096_employees_add->HireDate->Required) { ?>
		...
		<?php if ($t096_employees_add->Address->Required) { ?>
		...
		<?php } ?>
		<?php if ($t096_employees_add->City->Required) { ?>
		...
		<?php } ?>
		<?php if ($t096_employees_add->Region->Required) { ?>
		...
		<?php } ?>
		<?php if ($t096_employees_add->PostalCode->Required) { ?>
		...
		<?php } ?>
		<?php if ($t096_employees_add->Country->Required) { ?>
		...
		<?php } ?>
		<?php if ($t096_employees_add->HomePhone->Required) { ?>
		...
		<?php } ?>
		<?php if ($t096_employees_add->Extension->Required) { ?>
		...
		<?php } ?>
		<?php if ($t096_employees_add->_Email->Required) { ?>
		...
		<?php } ?>
		<?php if ($t096_employees_add->Photo->Required) { ?>
		...
		<?php } ?>
		<?php if ($t096_employees_add->Notes->Required) { ?>
		...
		<?php } ?>
		<?php if ($t096_employees_add->ReportsTo->Required) { ?>
		...
		<?php if ($t096_employees_add->Password->Required) { ?>
		...
		<?php } ?>
		<?php if ($t096_employees_add->UserLevel->Required) { ?>
		...
		<?php if ($t096_employees_add->Username->Required) { ?>
		...
		<?php } ?>
		<?php if ($t096_employees_add->Activated->Required) { ?>
		...
		<?php } ?>
		<?php if ($t096_employees_add->Profile->Required) { ?>
...
ft096_employeesadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
ft096_employeesadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ft096_employeesadd.lists["x_Activated[]"] = <?php echo $t096_employees_add->Activated->Lookup->toClientList() ?>;
ft096_employeesadd.lists["x_Activated[]"].options = <?php echo JsonEncode($t096_employees_add->Activated->options(FALSE, TRUE)) ?>;
...
<?php $t096_employees_add->showPageHeader(); ?>
<?php
$t096_employees_add->showMessage();
?>
<form name="ft096_employeesadd" id="ft096_employeesadd" class="<?php echo $t096_employees_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($t096_employees_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $t096_employees_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t096_employees">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$t096_employees_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($t096_employees->LastName->Visible) { // LastName ?>
	<div id="r_LastName" class="form-group row">
		<label id="elh_t096_employees_LastName" for="x_LastName" class="<?php echo $t096_employees_add->LeftColumnClass ?>"><?php echo $t096_employees->LastName->caption() ?><?php echo ($t096_employees->LastName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t096_employees_add->RightColumnClass ?>"><div<?php echo $t096_employees->LastName->cellAttributes() ?>>
...
<?php if ($t096_employees->FirstName->Visible) { // FirstName ?>
	<div id="r_FirstName" class="form-group row">
		<label id="elh_t096_employees_FirstName" for="x_FirstName" class="<?php echo $t096_employees_add->LeftColumnClass ?>"><?php echo $t096_employees->FirstName->caption() ?><?php echo ($t096_employees->FirstName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t096_employees_add->RightColumnClass ?>"><div<?php echo $t096_employees->FirstName->cellAttributes() ?>>
...
<?php if ($t096_employees->Title->Visible) { // Title ?>
	<div id="r_Title" class="form-group row">
		<label id="elh_t096_employees_Title" for="x_Title" class="<?php echo $t096_employees_add->LeftColumnClass ?>"><?php echo $t096_employees->Title->caption() ?><?php echo ($t096_employees->Title->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t096_employees_add->RightColumnClass ?>"><div<?php echo $t096_employees->Title->cellAttributes() ?>>
...
<?php if ($t096_employees->TitleOfCourtesy->Visible) { // TitleOfCourtesy ?>
	<div id="r_TitleOfCourtesy" class="form-group row">
		<label id="elh_t096_employees_TitleOfCourtesy" for="x_TitleOfCourtesy" class="<?php echo $t096_employees_add->LeftColumnClass ?>"><?php echo $t096_employees->TitleOfCourtesy->caption() ?><?php echo ($t096_employees->TitleOfCourtesy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t096_employees_add->RightColumnClass ?>"><div<?php echo $t096_employees->TitleOfCourtesy->cellAttributes() ?>>
...
<?php if ($t096_employees->BirthDate->Visible) { // BirthDate ?>
	<div id="r_BirthDate" class="form-group row">
		<label id="elh_t096_employees_BirthDate" for="x_BirthDate" class="<?php echo $t096_employees_add->LeftColumnClass ?>"><?php echo $t096_employees->BirthDate->caption() ?><?php echo ($t096_employees->BirthDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t096_employees_add->RightColumnClass ?>"><div<?php echo $t096_employees->BirthDate->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("ft096_employeesadd", "x_BirthDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($t096_employees->HireDate->Visible) { // HireDate ?>
	<div id="r_HireDate" class="form-group row">
		<label id="elh_t096_employees_HireDate" for="x_HireDate" class="<?php echo $t096_employees_add->LeftColumnClass ?>"><?php echo $t096_employees->HireDate->caption() ?><?php echo ($t096_employees->HireDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t096_employees_add->RightColumnClass ?>"><div<?php echo $t096_employees->HireDate->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("ft096_employeesadd", "x_HireDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($t096_employees->Address->Visible) { // Address ?>
	<div id="r_Address" class="form-group row">
		<label id="elh_t096_employees_Address" for="x_Address" class="<?php echo $t096_employees_add->LeftColumnClass ?>"><?php echo $t096_employees->Address->caption() ?><?php echo ($t096_employees->Address->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t096_employees_add->RightColumnClass ?>"><div<?php echo $t096_employees->Address->cellAttributes() ?>>
...
<?php if ($t096_employees->City->Visible) { // City ?>
	<div id="r_City" class="form-group row">
		<label id="elh_t096_employees_City" for="x_City" class="<?php echo $t096_employees_add->LeftColumnClass ?>"><?php echo $t096_employees->City->caption() ?><?php echo ($t096_employees->City->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t096_employees_add->RightColumnClass ?>"><div<?php echo $t096_employees->City->cellAttributes() ?>>
...
<?php if ($t096_employees->Region->Visible) { // Region ?>
	<div id="r_Region" class="form-group row">
		<label id="elh_t096_employees_Region" for="x_Region" class="<?php echo $t096_employees_add->LeftColumnClass ?>"><?php echo $t096_employees->Region->caption() ?><?php echo ($t096_employees->Region->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t096_employees_add->RightColumnClass ?>"><div<?php echo $t096_employees->Region->cellAttributes() ?>>
...
<?php if ($t096_employees->PostalCode->Visible) { // PostalCode ?>
	<div id="r_PostalCode" class="form-group row">
		<label id="elh_t096_employees_PostalCode" for="x_PostalCode" class="<?php echo $t096_employees_add->LeftColumnClass ?>"><?php echo $t096_employees->PostalCode->caption() ?><?php echo ($t096_employees->PostalCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t096_employees_add->RightColumnClass ?>"><div<?php echo $t096_employees->PostalCode->cellAttributes() ?>>
...
<?php if ($t096_employees->Country->Visible) { // Country ?>
	<div id="r_Country" class="form-group row">
		<label id="elh_t096_employees_Country" for="x_Country" class="<?php echo $t096_employees_add->LeftColumnClass ?>"><?php echo $t096_employees->Country->caption() ?><?php echo ($t096_employees->Country->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t096_employees_add->RightColumnClass ?>"><div<?php echo $t096_employees->Country->cellAttributes() ?>>
...
<?php if ($t096_employees->HomePhone->Visible) { // HomePhone ?>
	<div id="r_HomePhone" class="form-group row">
		<label id="elh_t096_employees_HomePhone" for="x_HomePhone" class="<?php echo $t096_employees_add->LeftColumnClass ?>"><?php echo $t096_employees->HomePhone->caption() ?><?php echo ($t096_employees->HomePhone->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t096_employees_add->RightColumnClass ?>"><div<?php echo $t096_employees->HomePhone->cellAttributes() ?>>
...
<?php if ($t096_employees->Extension->Visible) { // Extension ?>
	<div id="r_Extension" class="form-group row">
		<label id="elh_t096_employees_Extension" for="x_Extension" class="<?php echo $t096_employees_add->LeftColumnClass ?>"><?php echo $t096_employees->Extension->caption() ?><?php echo ($t096_employees->Extension->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t096_employees_add->RightColumnClass ?>"><div<?php echo $t096_employees->Extension->cellAttributes() ?>>
...
<?php if ($t096_employees->_Email->Visible) { // Email ?>
	<div id="r__Email" class="form-group row">
		<label id="elh_t096_employees__Email" for="x__Email" class="<?php echo $t096_employees_add->LeftColumnClass ?>"><?php echo $t096_employees->_Email->caption() ?><?php echo ($t096_employees->_Email->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t096_employees_add->RightColumnClass ?>"><div<?php echo $t096_employees->_Email->cellAttributes() ?>>
...
<?php if ($t096_employees->Photo->Visible) { // Photo ?>
	<div id="r_Photo" class="form-group row">
		<label id="elh_t096_employees_Photo" for="x_Photo" class="<?php echo $t096_employees_add->LeftColumnClass ?>"><?php echo $t096_employees->Photo->caption() ?><?php echo ($t096_employees->Photo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t096_employees_add->RightColumnClass ?>"><div<?php echo $t096_employees->Photo->cellAttributes() ?>>
...
<?php if ($t096_employees->Notes->Visible) { // Notes ?>
	<div id="r_Notes" class="form-group row">
		<label id="elh_t096_employees_Notes" for="x_Notes" class="<?php echo $t096_employees_add->LeftColumnClass ?>"><?php echo $t096_employees->Notes->caption() ?><?php echo ($t096_employees->Notes->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t096_employees_add->RightColumnClass ?>"><div<?php echo $t096_employees->Notes->cellAttributes() ?>>
...
<?php if ($t096_employees->ReportsTo->Visible) { // ReportsTo ?>
	<div id="r_ReportsTo" class="form-group row">
		<label id="elh_t096_employees_ReportsTo" for="x_ReportsTo" class="<?php echo $t096_employees_add->LeftColumnClass ?>"><?php echo $t096_employees->ReportsTo->caption() ?><?php echo ($t096_employees->ReportsTo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t096_employees_add->RightColumnClass ?>"><div<?php echo $t096_employees->ReportsTo->cellAttributes() ?>>
...
<?php if ($t096_employees->Password->Visible) { // Password ?>
	<div id="r_Password" class="form-group row">
		<label id="elh_t096_employees_Password" for="x_Password" class="<?php echo $t096_employees_add->LeftColumnClass ?>"><?php echo $t096_employees->Password->caption() ?><?php echo ($t096_employees->Password->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t096_employees_add->RightColumnClass ?>"><div<?php echo $t096_employees->Password->cellAttributes() ?>>
...
<?php if ($t096_employees->UserLevel->Visible) { // UserLevel ?>
	<div id="r_UserLevel" class="form-group row">
		<label id="elh_t096_employees_UserLevel" for="x_UserLevel" class="<?php echo $t096_employees_add->LeftColumnClass ?>"><?php echo $t096_employees->UserLevel->caption() ?><?php echo ($t096_employees->UserLevel->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t096_employees_add->RightColumnClass ?>"><div<?php echo $t096_employees->UserLevel->cellAttributes() ?>>
...
<?php if ($t096_employees->Username->Visible) { // Username ?>
	<div id="r_Username" class="form-group row">
		<label id="elh_t096_employees_Username" for="x_Username" class="<?php echo $t096_employees_add->LeftColumnClass ?>"><?php echo $t096_employees->Username->caption() ?><?php echo ($t096_employees->Username->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t096_employees_add->RightColumnClass ?>"><div<?php echo $t096_employees->Username->cellAttributes() ?>>
...
<?php if ($t096_employees->Activated->Visible) { // Activated ?>
	<div id="r_Activated" class="form-group row">
		<label id="elh_t096_employees_Activated" class="<?php echo $t096_employees_add->LeftColumnClass ?>"><?php echo $t096_employees->Activated->caption() ?><?php echo ($t096_employees->Activated->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t096_employees_add->RightColumnClass ?>"><div<?php echo $t096_employees->Activated->cellAttributes() ?>>
...
<?php if ($t096_employees->Profile->Visible) { // Profile ?>
	<div id="r_Profile" class="form-group row">
		<label id="elh_t096_employees_Profile" for="x_Profile" class="<?php echo $t096_employees_add->LeftColumnClass ?>"><?php echo $t096_employees->Profile->caption() ?><?php echo ($t096_employees->Profile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t096_employees_add->RightColumnClass ?>"><div<?php echo $t096_employees->Profile->cellAttributes() ?>>
...
<?php if (!$t096_employees_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $t096_employees_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $t096_employees_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$t096_employees_add->showPageFooter();
if (DEBUG_ENABLED)
