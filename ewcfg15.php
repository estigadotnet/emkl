...
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'FTxHkGDXDVtSBhbZ'); // Random key for encryption
...
$PROJECT_ID = "{D4B21A3D-A1C8-4ED3-BA65-212E10E691E7}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3307, "user" => "root", "pass" => "admin", "db" => "db_emkl", "qs" => "`", "qe" => "`");
...
define(PROJECT_NAMESPACE . "AUDIT_TRAIL_TABLE_NAME", "t399_audit_trail"); // Audit trail table name
define(PROJECT_NAMESPACE . "AUDIT_TRAIL_TABLE_VAR", "t399_audit_trail"); // Audit trail table var
