...
ft101_jo_headedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($t101_jo_head_edit->No_BL->Required) { ?>
...
<?php if ($t101_jo_head->No_BL->Visible) { // No_BL ?>
	<div id="r_No_BL" class="form-group row">
		<label id="elh_t101_jo_head_No_BL" for="x_No_BL" class="<?php echo $t101_jo_head_edit->LeftColumnClass ?>"><?php echo $t101_jo_head->No_BL->caption() ?><?php echo ($t101_jo_head->No_BL->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t101_jo_head_edit->RightColumnClass ?>"><div<?php echo $t101_jo_head->No_BL->cellAttributes() ?>>
