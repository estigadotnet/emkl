...
ft101_tagihan_truckinglist.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		if (checkrow) {
			addcnt++;
		<?php if ($t101_tagihan_trucking_list->JO_id->Required) { ?>
		...
		<?php } ?>
		<?php if ($t101_tagihan_trucking_list->Keterangan->Required) { ?>
...
<div id="xsr_3" class="ew-row d-sm-flex">
	<div class="ew-quick-search input-group">
		<input type="text" name="<?php echo TABLE_BASIC_SEARCH ?>" id="<?php echo TABLE_BASIC_SEARCH ?>" class="form-control" value="<?php echo HtmlEncode($t101_tagihan_trucking_list->BasicSearch->getKeyword()) ?>" placeholder="<?php echo HtmlEncode($Language->phrase("Search")) ?>">
		<input type="hidden" name="<?php echo TABLE_BASIC_SEARCH_TYPE ?>" id="<?php echo TABLE_BASIC_SEARCH_TYPE ?>" value="<?php echo HtmlEncode($t101_tagihan_trucking_list->BasicSearch->getType()) ?>">
		<div class="input-group-append">
			<button class="btn btn-primary" name="btn-submit" id="btn-submit" type="submit"><?php echo $Language->phrase("SearchBtn") ?></button>
			<button type="button" data-toggle="dropdown" class="btn btn-primary dropdown-toggle dropdown-toggle-split" aria-haspopup="true" aria-expanded="false"><span id="searchtype"><?php echo $t101_tagihan_trucking_list->BasicSearch->getTypeNameShort() ?></span></button>
			<div class="dropdown-menu dropdown-menu-right">
				<a class="dropdown-item<?php if ($t101_tagihan_trucking_list->BasicSearch->getType() == "") echo " active"; ?>" href="javascript:void(0);" onclick="ew.setSearchType(this)"><?php echo $Language->phrase("QuickSearchAuto") ?></a>
				<a class="dropdown-item<?php if ($t101_tagihan_trucking_list->BasicSearch->getType() == "=") echo " active"; ?>" href="javascript:void(0);" onclick="ew.setSearchType(this,'=')"><?php echo $Language->phrase("QuickSearchExact") ?></a>
				<a class="dropdown-item<?php if ($t101_tagihan_trucking_list->BasicSearch->getType() == "AND") echo " active"; ?>" href="javascript:void(0);" onclick="ew.setSearchType(this,'AND')"><?php echo $Language->phrase("QuickSearchAll") ?></a>
				<a class="dropdown-item<?php if ($t101_tagihan_trucking_list->BasicSearch->getType() == "OR") echo " active"; ?>" href="javascript:void(0);" onclick="ew.setSearchType(this,'OR')"><?php echo $Language->phrase("QuickSearchAny") ?></a>
			</div>
		</div>
	</div>
</div>
...
<span id="el<?php echo $t101_tagihan_trucking_list->RowCnt ?>_t101_tagihan_trucking_Keterangan" class="form-group t101_tagihan_trucking_Keterangan">
<textarea data-table="t101_tagihan_trucking" data-field="x_Keterangan" name="x<?php echo $t101_tagihan_trucking_list->RowIndex ?>_Keterangan" id="x<?php echo $t101_tagihan_trucking_list->RowIndex ?>_Keterangan" cols="35" rows="4" placeholder="<?php echo HtmlEncode($t101_tagihan_trucking->Keterangan->getPlaceHolder()) ?>"<?php echo $t101_tagihan_trucking->Keterangan->editAttributes() ?>><?php echo $t101_tagihan_trucking->Keterangan->EditValue ?></textarea>
</span>
<input type="hidden" data-table="t101_tagihan_trucking" data-field="x_Keterangan" name="o<?php echo $t101_tagihan_trucking_list->RowIndex ?>_Keterangan" id="o<?php echo $t101_tagihan_trucking_list->RowIndex ?>_Keterangan" value="<?php echo HtmlEncode($t101_tagihan_trucking->Keterangan->OldValue) ?>">
</td>
	<?php } ?>
	<?php if ($t101_tagihan_trucking->Tagihan->Visible) { // Tagihan ?>
...
<span id="el<?php echo $t101_tagihan_trucking_list->RowCnt ?>_t101_tagihan_trucking_JO_id" class="t101_tagihan_trucking_JO_id">
...
<?php } ?>
<?php if ($t101_tagihan_trucking->RowType == ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $t101_tagihan_trucking_list->RowCnt ?>_t101_tagihan_trucking_Keterangan" class="t101_tagihan_trucking_Keterangan">
...
<input type="hidden" data-table="t101_tagihan_trucking" data-field="x_Nomor_Container_2" name="o<?php echo $t101_tagihan_trucking_list->RowIndex ?>_Nomor_Container_2" id="o<?php echo $t101_tagihan_trucking_list->RowIndex ?>_Nomor_Container_2" value="<?php echo HtmlEncode($t101_tagihan_trucking->Nomor_Container_2->OldValue) ?>">
	...
	<?php if ($t101_tagihan_trucking->Keterangan->Visible) { // Keterangan ?>
		<td data-name="Keterangan">
<span id="el$rowindex$_t101_tagihan_trucking_Keterangan" class="form-group t101_tagihan_trucking_Keterangan">
<textarea data-table="t101_tagihan_trucking" data-field="x_Keterangan" name="x<?php echo $t101_tagihan_trucking_list->RowIndex ?>_Keterangan" id="x<?php echo $t101_tagihan_trucking_list->RowIndex ?>_Keterangan" cols="35" rows="4" placeholder="<?php echo HtmlEncode($t101_tagihan_trucking->Keterangan->getPlaceHolder()) ?>"<?php echo $t101_tagihan_trucking->Keterangan->editAttributes() ?>><?php echo $t101_tagihan_trucking->Keterangan->EditValue ?></textarea>
</span>
<input type="hidden" data-table="t101_tagihan_trucking" data-field="x_Keterangan" name="o<?php echo $t101_tagihan_trucking_list->RowIndex ?>_Keterangan" id="o<?php echo $t101_tagihan_trucking_list->RowIndex ?>_Keterangan" value="<?php echo HtmlEncode($t101_tagihan_trucking->Keterangan->OldValue) ?>">
</td>
...
<?php if (!$t101_tagihan_trucking->isExport()) { ?>
<script>
ew.scrollableTable("gmp_t101_tagihan_trucking", "100%", "");
</script>
<?php } ?>
<?php } ?>
