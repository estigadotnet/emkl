...
<?php if ($t002_destination->id->Visible) { // id ?>
	...
	<?php } else { ?>
		<th data-name="id" class="<?php echo $t002_destination->id->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $t002_destination->SortUrl($t002_destination->id) ?>',2);"><div id="elh_t002_destination_id" class="t002_destination_id">
...
<?php if ($t002_destination->Nama->Visible) { // Nama ?>
	...
	<?php } else { ?>
		<th data-name="Nama" class="<?php echo $t002_destination->Nama->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $t002_destination->SortUrl($t002_destination->Nama) ?>',2);"><div id="elh_t002_destination_Nama" class="t002_destination_Nama">
...
<?php } ?>
<?php if ($t002_destination_list->TotalRecs > 0 && (!$t002_destination_list->AutoHidePageSizeSelector || $t002_destination_list->Pager->Visible)) { ?>
<div class="ew-pager">
<input type="hidden" name="t" value="t002_destination">
<select name="<?php echo TABLE_REC_PER_PAGE ?>" class="form-control form-control-sm ew-tooltip" title="<?php echo $Language->phrase("RecordsPerPage") ?>" onchange="this.form.submit();">
<option value="10"<?php if ($t002_destination_list->DisplayRecs == 10) { ?> selected<?php } ?>>10</option>
<option value="20"<?php if ($t002_destination_list->DisplayRecs == 20) { ?> selected<?php } ?>>20</option>
<option value="50"<?php if ($t002_destination_list->DisplayRecs == 50) { ?> selected<?php } ?>>50</option>
<option value="100"<?php if ($t002_destination_list->DisplayRecs == 100) { ?> selected<?php } ?>>100</option>
<option value="ALL"<?php if ($t002_destination->getRecordsPerPage() == -1) { ?> selected<?php } ?>><?php echo $Language->Phrase("AllRecords") ?></option>
</select>
</div>
<?php } ?>
</form>
...
<?php if (!$t002_destination->isExport()) { ?>
<script>
ew.scrollableTable("gmp_t002_destination", "100%", "");
</script>
<?php } ?>
<?php } ?>
