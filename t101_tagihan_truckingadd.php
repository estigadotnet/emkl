...
// Create page object
$t101_tagihan_trucking_add = new t101_tagihan_trucking_add();

// Run the page
$t101_tagihan_trucking_add->run();
...
$t101_tagihan_trucking_add->Page_Render();
?>
...
var ft101_tagihan_truckingadd = currentForm = new ew.Form("ft101_tagihan_truckingadd", "add");

// Validate form
ft101_tagihan_truckingadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($t101_tagihan_trucking_add->Nomor_Polisi_2->Required) { ?>
		...
		<?php } ?>
		<?php if ($t101_tagihan_trucking_add->Nomor_Polisi_3->Required) { ?>
		...
		<?php } ?>
		<?php if ($t101_tagihan_trucking_add->Tanggal->Required) { ?>
		...
		<?php if ($t101_tagihan_trucking_add->Shipper_id->Required) { ?>
		...
		<?php } ?>
		<?php if ($t101_tagihan_trucking_add->Dari_Lokasi->Required) { ?>
		...
		<?php } ?>
		<?php if ($t101_tagihan_trucking_add->Ke_Lokasi->Required) { ?>
		...
		<?php } ?>
		<?php if ($t101_tagihan_trucking_add->Nomor_Container_2->Required) { ?>
		...
		<?php } ?>
		<?php if ($t101_tagihan_trucking_add->Keterangan->Required) { ?>
		...
		<?php } ?>
		<?php if ($t101_tagihan_trucking_add->Tagihan->Required) { ?>
...
ft101_tagihan_truckingadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
<?php $t101_tagihan_trucking_add->showPageHeader(); ?>
<?php
$t101_tagihan_trucking_add->showMessage();
?>
<form name="ft101_tagihan_truckingadd" id="ft101_tagihan_truckingadd" class="<?php echo $t101_tagihan_trucking_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($t101_tagihan_trucking_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $t101_tagihan_trucking_add->Token ?>">
<?php } ?>
...
<?php if ($t101_tagihan_trucking->Nomor_Polisi_1->Visible) { // Nomor_Polisi_1 ?>
	<div id="r_Nomor_Polisi_1" class="form-group row">
		...
		<div class="<?php echo $t101_tagihan_trucking_add->RightColumnClass ?>"><div<?php echo $t101_tagihan_trucking->Nomor_Polisi_1->cellAttributes() ?>>
...
<?php if ($t101_tagihan_trucking->Nomor_Polisi_2->Visible) { // Nomor_Polisi_2 ?>
	<div id="r_Nomor_Polisi_2" class="form-group row">
		<label id="elh_t101_tagihan_trucking_Nomor_Polisi_2" for="x_Nomor_Polisi_2" class="<?php echo $t101_tagihan_trucking_add->LeftColumnClass ?>"><?php echo $t101_tagihan_trucking->Nomor_Polisi_2->caption() ?><?php echo ($t101_tagihan_trucking->Nomor_Polisi_2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t101_tagihan_trucking_add->RightColumnClass ?>"><div<?php echo $t101_tagihan_trucking->Nomor_Polisi_2->cellAttributes() ?>>
...
<?php if ($t101_tagihan_trucking->Nomor_Polisi_3->Visible) { // Nomor_Polisi_3 ?>
	<div id="r_Nomor_Polisi_3" class="form-group row">
		<label id="elh_t101_tagihan_trucking_Nomor_Polisi_3" for="x_Nomor_Polisi_3" class="<?php echo $t101_tagihan_trucking_add->LeftColumnClass ?>"><?php echo $t101_tagihan_trucking->Nomor_Polisi_3->caption() ?><?php echo ($t101_tagihan_trucking->Nomor_Polisi_3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t101_tagihan_trucking_add->RightColumnClass ?>"><div<?php echo $t101_tagihan_trucking->Nomor_Polisi_3->cellAttributes() ?>>
...
<?php if ($t101_tagihan_trucking->Tanggal->Visible) { // Tanggal ?>
	<div id="r_Tanggal" class="form-group row">
		<label id="elh_t101_tagihan_trucking_Tanggal" for="x_Tanggal" class="<?php echo $t101_tagihan_trucking_add->LeftColumnClass ?>"><?php echo $t101_tagihan_trucking->Tanggal->caption() ?><?php echo ($t101_tagihan_trucking->Tanggal->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t101_tagihan_trucking_add->RightColumnClass ?>"><div<?php echo $t101_tagihan_trucking->Tanggal->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("ft101_tagihan_truckingadd", "x_Tanggal", {"ignoreReadonly":true,"useCurrent":false,"format":7});
</script>
<?php } ?>
</span>
...
<?php if ($t101_tagihan_trucking->Shipper_id->Visible) { // Shipper_id ?>
	<div id="r_Shipper_id" class="form-group row">
		<label id="elh_t101_tagihan_trucking_Shipper_id" for="x_Shipper_id" class="<?php echo $t101_tagihan_trucking_add->LeftColumnClass ?>"><?php echo $t101_tagihan_trucking->Shipper_id->caption() ?><?php echo ($t101_tagihan_trucking->Shipper_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t101_tagihan_trucking_add->RightColumnClass ?>"><div<?php echo $t101_tagihan_trucking->Shipper_id->cellAttributes() ?>>
...
<?php if ($t101_tagihan_trucking->Dari_Lokasi->Visible) { // Dari_Lokasi ?>
	<div id="r_Dari_Lokasi" class="form-group row">
		<label id="elh_t101_tagihan_trucking_Dari_Lokasi" for="x_Dari_Lokasi" class="<?php echo $t101_tagihan_trucking_add->LeftColumnClass ?>"><?php echo $t101_tagihan_trucking->Dari_Lokasi->caption() ?><?php echo ($t101_tagihan_trucking->Dari_Lokasi->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t101_tagihan_trucking_add->RightColumnClass ?>"><div<?php echo $t101_tagihan_trucking->Dari_Lokasi->cellAttributes() ?>>
...
<?php if ($t101_tagihan_trucking->Ke_Lokasi->Visible) { // Ke_Lokasi ?>
	<div id="r_Ke_Lokasi" class="form-group row">
		<label id="elh_t101_tagihan_trucking_Ke_Lokasi" for="x_Ke_Lokasi" class="<?php echo $t101_tagihan_trucking_add->LeftColumnClass ?>"><?php echo $t101_tagihan_trucking->Ke_Lokasi->caption() ?><?php echo ($t101_tagihan_trucking->Ke_Lokasi->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t101_tagihan_trucking_add->RightColumnClass ?>"><div<?php echo $t101_tagihan_trucking->Ke_Lokasi->cellAttributes() ?>>
...
<?php if ($t101_tagihan_trucking->Nomor_Container_1->Visible) { // Nomor_Container_1 ?>
	<div id="r_Nomor_Container_1" class="form-group row">
		<label id="elh_t101_tagihan_trucking_Nomor_Container_1" for="x_Nomor_Container_1" class="<?php echo $t101_tagihan_trucking_add->LeftColumnClass ?>"><?php echo $t101_tagihan_trucking->Nomor_Container_1->caption() ?><?php echo ($t101_tagihan_trucking->Nomor_Container_1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t101_tagihan_trucking_add->RightColumnClass ?>"><div<?php echo $t101_tagihan_trucking->Nomor_Container_1->cellAttributes() ?>>
...
<?php if ($t101_tagihan_trucking->Nomor_Container_2->Visible) { // Nomor_Container_2 ?>
	<div id="r_Nomor_Container_2" class="form-group row">
		<label id="elh_t101_tagihan_trucking_Nomor_Container_2" for="x_Nomor_Container_2" class="<?php echo $t101_tagihan_trucking_add->LeftColumnClass ?>"><?php echo $t101_tagihan_trucking->Nomor_Container_2->caption() ?><?php echo ($t101_tagihan_trucking->Nomor_Container_2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t101_tagihan_trucking_add->RightColumnClass ?>"><div<?php echo $t101_tagihan_trucking->Nomor_Container_2->cellAttributes() ?>>
...
<?php if ($t101_tagihan_trucking->Keterangan->Visible) { // Keterangan ?>
	<div id="r_Keterangan" class="form-group row">
		<label id="elh_t101_tagihan_trucking_Keterangan" for="x_Keterangan" class="<?php echo $t101_tagihan_trucking_add->LeftColumnClass ?>"><?php echo $t101_tagihan_trucking->Keterangan->caption() ?><?php echo ($t101_tagihan_trucking->Keterangan->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t101_tagihan_trucking_add->RightColumnClass ?>"><div<?php echo $t101_tagihan_trucking->Keterangan->cellAttributes() ?>>
...
<?php if ($t101_tagihan_trucking->Tagihan->Visible) { // Tagihan ?>
	<div id="r_Tagihan" class="form-group row">
		<label id="elh_t101_tagihan_trucking_Tagihan" for="x_Tagihan" class="<?php echo $t101_tagihan_trucking_add->LeftColumnClass ?>"><?php echo $t101_tagihan_trucking->Tagihan->caption() ?><?php echo ($t101_tagihan_trucking->Tagihan->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t101_tagihan_trucking_add->RightColumnClass ?>"><div<?php echo $t101_tagihan_trucking->Tagihan->cellAttributes() ?>>
...
<?php if (!$t101_tagihan_trucking_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $t101_tagihan_trucking_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $t101_tagihan_trucking_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$t101_tagihan_trucking_add->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$t101_tagihan_trucking_add->terminate();
?>