...
// Create page object
$t399_audit_trail_edit = new t399_audit_trail_edit();

// Run the page
$t399_audit_trail_edit->run();
...
$t399_audit_trail_edit->Page_Render();
?>
...
var ft399_audit_trailedit = currentForm = new ew.Form("ft399_audit_trailedit", "edit");

// Validate form
ft399_audit_trailedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($t399_audit_trail_edit->id->Required) { ?>
			elm = this.getElements("x" + infix + "_id");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $t399_audit_trail->id->caption(), $t399_audit_trail->id->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($t399_audit_trail_edit->datetime->Required) { ?>
		...
		<?php if ($t399_audit_trail_edit->script->Required) { ?>
		...
		<?php } ?>
		<?php if ($t399_audit_trail_edit->user->Required) { ?>
		...
		<?php } ?>
		<?php if ($t399_audit_trail_edit->_action->Required) { ?>
		...
		<?php } ?>
		<?php if ($t399_audit_trail_edit->_table->Required) { ?>
		...
		<?php } ?>
		<?php if ($t399_audit_trail_edit->field->Required) { ?>
		...
		<?php } ?>
		<?php if ($t399_audit_trail_edit->keyvalue->Required) { ?>
		...
		<?php } ?>
		<?php if ($t399_audit_trail_edit->oldvalue->Required) { ?>
		...
		<?php } ?>
		<?php if ($t399_audit_trail_edit->newvalue->Required) { ?>
...
ft399_audit_trailedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
ft399_audit_trailedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $t399_audit_trail_edit->showPageHeader(); ?>
<?php
$t399_audit_trail_edit->showMessage();
?>
<form name="ft399_audit_trailedit" id="ft399_audit_trailedit" class="<?php echo $t399_audit_trail_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($t399_audit_trail_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $t399_audit_trail_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t399_audit_trail">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$t399_audit_trail_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($t399_audit_trail->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_t399_audit_trail_id" class="<?php echo $t399_audit_trail_edit->LeftColumnClass ?>"><?php echo $t399_audit_trail->id->caption() ?><?php echo ($t399_audit_trail->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t399_audit_trail_edit->RightColumnClass ?>"><div<?php echo $t399_audit_trail->id->cellAttributes() ?>>
<span id="el_t399_audit_trail_id">
<span<?php echo $t399_audit_trail->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($t399_audit_trail->id->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="t399_audit_trail" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($t399_audit_trail->id->CurrentValue) ?>">
<?php echo $t399_audit_trail->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t399_audit_trail->datetime->Visible) { // datetime ?>
	<div id="r_datetime" class="form-group row">
		<label id="elh_t399_audit_trail_datetime" for="x_datetime" class="<?php echo $t399_audit_trail_edit->LeftColumnClass ?>"><?php echo $t399_audit_trail->datetime->caption() ?><?php echo ($t399_audit_trail->datetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t399_audit_trail_edit->RightColumnClass ?>"><div<?php echo $t399_audit_trail->datetime->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("ft399_audit_trailedit", "x_datetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($t399_audit_trail->script->Visible) { // script ?>
	<div id="r_script" class="form-group row">
		<label id="elh_t399_audit_trail_script" for="x_script" class="<?php echo $t399_audit_trail_edit->LeftColumnClass ?>"><?php echo $t399_audit_trail->script->caption() ?><?php echo ($t399_audit_trail->script->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t399_audit_trail_edit->RightColumnClass ?>"><div<?php echo $t399_audit_trail->script->cellAttributes() ?>>
...
<?php if ($t399_audit_trail->user->Visible) { // user ?>
	<div id="r_user" class="form-group row">
		<label id="elh_t399_audit_trail_user" for="x_user" class="<?php echo $t399_audit_trail_edit->LeftColumnClass ?>"><?php echo $t399_audit_trail->user->caption() ?><?php echo ($t399_audit_trail->user->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t399_audit_trail_edit->RightColumnClass ?>"><div<?php echo $t399_audit_trail->user->cellAttributes() ?>>
...
<?php if ($t399_audit_trail->_action->Visible) { // action ?>
	<div id="r__action" class="form-group row">
		<label id="elh_t399_audit_trail__action" for="x__action" class="<?php echo $t399_audit_trail_edit->LeftColumnClass ?>"><?php echo $t399_audit_trail->_action->caption() ?><?php echo ($t399_audit_trail->_action->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t399_audit_trail_edit->RightColumnClass ?>"><div<?php echo $t399_audit_trail->_action->cellAttributes() ?>>
...
<?php if ($t399_audit_trail->_table->Visible) { // table ?>
	<div id="r__table" class="form-group row">
		<label id="elh_t399_audit_trail__table" for="x__table" class="<?php echo $t399_audit_trail_edit->LeftColumnClass ?>"><?php echo $t399_audit_trail->_table->caption() ?><?php echo ($t399_audit_trail->_table->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t399_audit_trail_edit->RightColumnClass ?>"><div<?php echo $t399_audit_trail->_table->cellAttributes() ?>>
...
<?php if ($t399_audit_trail->field->Visible) { // field ?>
	<div id="r_field" class="form-group row">
		<label id="elh_t399_audit_trail_field" for="x_field" class="<?php echo $t399_audit_trail_edit->LeftColumnClass ?>"><?php echo $t399_audit_trail->field->caption() ?><?php echo ($t399_audit_trail->field->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t399_audit_trail_edit->RightColumnClass ?>"><div<?php echo $t399_audit_trail->field->cellAttributes() ?>>
...
<?php if ($t399_audit_trail->keyvalue->Visible) { // keyvalue ?>
	<div id="r_keyvalue" class="form-group row">
		<label id="elh_t399_audit_trail_keyvalue" for="x_keyvalue" class="<?php echo $t399_audit_trail_edit->LeftColumnClass ?>"><?php echo $t399_audit_trail->keyvalue->caption() ?><?php echo ($t399_audit_trail->keyvalue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t399_audit_trail_edit->RightColumnClass ?>"><div<?php echo $t399_audit_trail->keyvalue->cellAttributes() ?>>
...
<?php if ($t399_audit_trail->oldvalue->Visible) { // oldvalue ?>
	<div id="r_oldvalue" class="form-group row">
		<label id="elh_t399_audit_trail_oldvalue" for="x_oldvalue" class="<?php echo $t399_audit_trail_edit->LeftColumnClass ?>"><?php echo $t399_audit_trail->oldvalue->caption() ?><?php echo ($t399_audit_trail->oldvalue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t399_audit_trail_edit->RightColumnClass ?>"><div<?php echo $t399_audit_trail->oldvalue->cellAttributes() ?>>
...
<?php if ($t399_audit_trail->newvalue->Visible) { // newvalue ?>
	<div id="r_newvalue" class="form-group row">
		<label id="elh_t399_audit_trail_newvalue" for="x_newvalue" class="<?php echo $t399_audit_trail_edit->LeftColumnClass ?>"><?php echo $t399_audit_trail->newvalue->caption() ?><?php echo ($t399_audit_trail->newvalue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t399_audit_trail_edit->RightColumnClass ?>"><div<?php echo $t399_audit_trail->newvalue->cellAttributes() ?>>
...
<?php if (!$t399_audit_trail_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $t399_audit_trail_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $t399_audit_trail_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$t399_audit_trail_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$t399_audit_trail_edit->terminate();
?>